...
Computational Engineering, Scientific Computing, Bone Mechanics, Medical Imaging, Finite Element Analysis
\fi
...
\begin{innerlist}
	...
	\begin{innerlist}
		\item[] \textbf{Thesis:} \emph{Design and Implementation of an Elastography Apparatus for Mechanical Characterization of Soft Tissues}
...
\section{Teaching \& Coaching Experience}
...
\begin{innerlist}
	\item[] \href{https://www.udemy.com/course/materialise-mimics/}{Udemy}, Online platform
	\if\longversion1
	\begin{innerlist}
...
\begin{innerlist}
	\item[] \href{https://www.materialise.com/en}{Materialise Co.}, Leuven, Belgium
	\if\longversion1
	\begin{innerlist}
...
\textbf{Collaborated with Mathys company}, {2018-2019}
\begin{innerlist}
	\item[] \href{https://www.mathysmedical.com/en/homepage}{Mathys Co.}, Bettlach, Switzerland
	\if\longversion1
	\begin{innerlist}
		\item Assessing the feasibility and mechanical performance of a cemented short stem for the first time in patients with poor bone stock.
	\end{innerlist}
	\fi
\end{innerlist}
...
\section{Talks and \\Presentations}
	...
	\href{https://scholar.google.com/citations?view_op=view_citation&hl=en&user=C-ZuElMAAAAJ&sortby=pubdate&citation_for_view=C-ZuElMAAAAJ:Y0pCki6q_DkC}{\textbf{Photon-counting CT appears promising in quantifying bone microstructure in the knee}}\\
          \textit{50th Congress of the European Calcified Tissue Society}, April 2023, Liverpool, United Kingdom
...
\halfblankline
	...
	\href{https://scholar.google.com/citations?view_op=view_citation&hl=en&user=C-ZuElMAAAAJ&citation_for_view=C-ZuElMAAAAJ:9yKSN-GCB0IC7}{\textbf{Cemented short-stem total hip arthroplasty appears promising in patients with poor bone quality}}\\
\textit{26th Congress of the European Society of Biomechanics (remote)}, August 2021, Milan, Italy
...
\textit{18th National Day on Biomedical Engineering, Artificial Intelligence in Medicine}, November 2019, Brussels, Belgium
